...
while exitCode == 0:
    if ((len(fullInput) - currentExecutePointer) > 0): #if anywhere for instruction
        ...
        if currentInstruction[0] == "01": # ADD
            ...
            print(fullInput[params[0]]); # I HAVE HUGE FUCKING DOUBTS ABOUT THIS
...
if exitCode == 1:
    ...
    if exitCode == 2:
        print("Unrecognised command; commands must be suffixed with 01, 02, 03, 04, or 99.");
    elif exitCode == 3:
